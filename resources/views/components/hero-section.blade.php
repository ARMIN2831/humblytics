    ...
    <div class="border border-[#f0f0f0] w-full bg-[#fcfcfc] text-center delay-0 rounded-t-[2rem] rounded-b-md">
        <div class="pt-8 px-16 flex flex-col gap-2 items-center">
            <div class="border border-[#f0f0f0] flex flex-row gap-2 bg-white justify-center items-center rounded-full  mb-4 py-1 px-2.5">
                ...
                <div class="text-xs">
                    <span class="font-semibold">Cookie-Free GA4 Alternative</span>
                    - Track Custom Events, Run A/B Split Tests and Unlock Growth!
                </div>
            </div>
            <div class="flex flex-col justify-center items-center gap-4 max-w-[45rem]">
                ...
                <p class="text-[#3f3f3f] max-w-[35rem] text-center">
                    ...
                    form submissions,
                    <span class="text-[#ff7a00] font-medium">optimize</span>
                    conversion rates with A/B testing and gain insights into user behaviour.
                </p>
            </div>
            <div class="flex flex-row justify-center items-center my-4 gap-2">
                <div class="w-28 relative box-border flex flex-row">
                    <img src="{{ asset('assets/photos/people.jpeg') }}" class="border border-[#f0f0f0] w-6 h-6 rounded-full relative right-[-8px]">
                    <img src="{{ asset('assets/photos/people2.webp') }}" sizes="24px" class="border border-[#f0f0f0] w-6 h-6 rounded-full relative">
                    <img src="{{ asset('assets/photos/people3.jpg') }}" class="border border-[#f0f0f0] w-6 h-6 rounded-full relative left-[-8px]">
                    <img src="{{ asset('assets/photos/people4.jpg') }}" class="border border-[#f0f0f0] w-6 h-6 rounded-full relative left-[-11px]">
                    <img src="{{ asset('assets/photos/people5.jpeg') }}" sizes="24px" class="border border-[#f0f0f0] w-6 h-6 rounded-full relative left-[-16px]">
                </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="text-[#3f3f3f] mt-3 text-xs font-medium">Your first 1,000 Views and Events are free to track!</div>
            </div>
            <div class="bg-[#ff7a00] w-1/2 h-4 relative bottom-[-65px] blur-[30px] z-0 animate-heroAnimate"></div>
            <div class="mt-6 border border-[#f0f0f0] bg-[rgba(248, 248, 248, .59)] px-1 rounded-t-[1rem] z-10">
                <img src="{{ asset('assets/photos/heroSection.png') }}">
            </div>
        </div>
    </div>
