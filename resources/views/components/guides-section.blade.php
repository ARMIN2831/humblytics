<section class="container pt-12 mt-16 pb-24">
    <div class="flex flex-col mb-12 w-full gap-2">
        <h2 class="text-3xl max-sm:text-xl font-medium text-[#202020]">Quick Start: Installation Guide</h2>
        <p class="max-sm:text-sm text-[#3f3f3f]">Learn how to get started with Humblytics.</p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-12">
        <a class="flex flex-col gap-2">
            <img style="background-image: url({{ asset('assets/photos/guide1.png') }})" class="overflow-hidden rounded-md w-full h-[16rem] bg-center bg-no-repeat bg-[length:496px_16rem] object-contain" alt="" src="{{ asset('assets/photos/guide1.png') }}">
        ...
        <a class="flex flex-col gap-2">
            <img style="background-image: url({{ asset('assets/photos/guide2.png') }})" class="overflow-hidden rounded-md w-full h-[16rem] bg-center bg-no-repeat bg-[length:496px_16rem] object-contain" alt="" src="{{ asset('assets/photos/guide2.png') }}">
            <div class="text-[#3f3f3f] text-xs">May 12, 2024</div>
    ...
    <div class="flex flex-col mb-12 w-full gap-2">
        <h2 class="text-3xl max-sm:text-xl font-medium text-[#202020]">For Marketers: Accelerate Growth with Webflow and Framer A/B Testing</h2>
        <p class="max-sm:text-sm text-[#3f3f3f]">Learn how to increase conversions with A/B Split Testing for Webflow and Framer.</p>
    </div>
    ...
    <div class="flex flex-col mb-12 w-full gap-2 pt-4">
        <h2 class="text-3xl max-sm:text-xl font-medium text-[#202020]">Maximize Performance: SEO and Performance</h2>
        <p class="max-sm:text-sm text-[#3f3f3f]">Improve your page speed performance, SEO, and user experience for your Webflow and Framer website.</p>
    </div>
    ...
    <div class="flex flex-col mb-12 w-full gap-2 pt-4">
        <h2 class="text-3xl max-sm:text-xl font-medium text-[#202020]">Unlock Growth with Simple and Privacy Friendly Analytics</h2>
        <p class="max-sm:text-sm text-[#3f3f3f]">Humblytics is the ultimate cookie-free GA4 alternative, learn more about how you can use Humblytics to optimize your conversions.</p>
    </div>
